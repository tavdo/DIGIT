        ...
        <div className="container hero__inner">
          <div className="hero__content">
            <Reveal variant="fade" className="hero__eyebrow-wrap">
              <span className="hero__eyebrow">{tObject(content, 'heroEyebrow')}</span>
            </Reveal>
            <Reveal delay={80}>
              <span className="relay-line" />
              <h1 className="hero__title">
                <span className="hero__title-main">{tObject(content, 'heroTitle')}</span>
                <br />
                <span className="hero__title-accent">{tObject(content, 'heroTitleAccent')}</span>
              </h1>
            </Reveal>
            <Reveal delay={160}>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            {visibleServices.map((service, index) => {
              ...
              return (
                <Reveal key={service.id} className="service-card" delay={index * 70} variant="up">
                  <div className="service-card__thread" aria-hidden="true" />
                  <div className="service-card__icon">
                    <Icon size={24} strokeWidth={1.75} />
                  </div>
                  <h3 className="service-card__title">{tObject(service, 'title')}</h3>
                  <p className="service-card__text">{tObject(service, 'description')}</p>
                </Reveal>
              )
            })}
          </div>

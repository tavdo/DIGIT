...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const selectedService = content?.services?.find(s => s.id === selectedServiceId)
    const serviceType = selectedService ? (tObject(selectedService, 'title') || selectedService.title) : 'General Problem'
    ...
    try {
      await createTicket({
        customerId: user.uid,
        customerName:
          userProfile?.name || user.displayName || user.email?.split('@')[0] || t('roles.customer'),
          ...
          {success ? (
            ...
            <div className="ticket-layout">
                ...
                <div className="ticket-form__field">
                  ...
                  <div className="ticket-priority">
                    <button
                      ...
                      disabled={submitting}
                    >
                      <span style={{ width: '8px', height: '8px', background: '#ff3333', borderRadius: '50%' }} />
                    ...
                    <button
                      ...
                      disabled={submitting}
                    >
                      <span style={{ width: '8px', height: '8px', background: '#ffaa00', borderRadius: '50%' }} />
              ...
              <aside className="contact-info">
                <h2 className="contact-info__title">{t('contact.otherContact')}</h2>
                <ul className="contact-info__list">
                  ...
                  <li>
                    ...
                    <div>
                      <span className="contact-info__label">{t('contact.workingHours')}</span>

...
function About() {
  ...
  usePageMeta(pageTitle(t("about.metaTitle")), t("about.metaDesc"));
      ...
      <section className="about-mission">
        <div className="container">
          <Reveal className="about-mission__inner">
            <span className="about-mission__label">
        ...
        <div className="container">
          ...
          <div className="about-work__steps">
            {workSteps.map(({ icon: Icon, title, description }, index) => (
              <Reveal
                key={title}
                className="about-work__step"
                delay={index * 100}
              >
                <div className="about-work__step-blob" />
                <div className="about-work__step-bg" />
                <div className="about-work__step-content">
      ...
      <section className="about-section about-faq">
        <div className="container">
          <Reveal className="about-section__header">
            ...
            <p className="about-section__subtitle">{t("about.faqSubtitle")}</p>
          </Reveal>
          ...
          <div className="about-trust__grid">
            {trustBadges.map(({ icon: Icon, title, text }, index) => (
              <Reveal key={title} className="trust-badge" delay={index * 80}>
                <div className="trust-badge__blob" />
                <div className="trust-badge__bg" />
